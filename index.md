...
| **2026-05-27** — 금융시장 동향 추가: KOSPI 8,047.51(+2.55%), KOSDAQ 1,172.52(+0.98%), 다우 50,830+신기록, S&P 500 7,511.79(+0.51%), 나스닥 26,635.22(+0.88%), 금 $4,498.60(-1.16%), WTI $93.92(-2.78%), 삼성전자 302,500(+3.24%), SK하이닉스 2,052,000(+5.72%) — 중동 평화협정으로 유가 급락, 미국/한국 동시 강세, SK하이닉스 역사적 200만원대 진입
||| | **2026-05-25** — YouTube 분석: LM Studio MTP 설정으로 로컬 AI 속도 더블업 (품질 저하 무, 토큰/초 2x 향상, AsapGuide) — M5 맥스와 완벽한 매칭, Antigravity-K API 연동 가능
|| **2026-05-27** — YouTube 분석 5건 추가: Agent OS 7-Layer 구조 (우리 시스템의 7-layer와 1:1 분석), OpenAI Personal Finance(Plaid 연동 인사이트), Hermes SEO Super Agent(Goal Mode/Kanban), Video Agent(Vision Forge), Claude Goal 트레이딩 백테스트 — **벤치마킹 완료** — 주요 작용점: Command Center 대시보드 장기 검토, 백테스트 goal-mode Antigravity-K 연동, Plaid API 향후 금융데이터 실시간 연동, Kanban+Swarm Mode 병렬 분석
...
||| | **2026-05-25** — Paperclip 완전히 무료(MIT) 확인
...
|| **2026-05-29** — AI-Trend Weekly Report W42 (5/22~5/29): Claude Opus 4.8, Gemini 3.5 Flash, GPT-5.5 Instant — 마크다운 + HTML 다크테마 [AI-Trend/AI-Trend-Report-W42-2026.md](AI-Trend/AI-Trend-Report-W42-2026.md) / [reports/AI-Trend-Report-W42-2026.html](reports/AI-Trend-Report-W42-2026.html)|
| **2026-05-29** — YouTube 분석 3건 추가: [Hermes Agent v0.15](YouTube-Videos/20260529_youtube_hermes-agent-v015.md) / [Oracle Cloud Free Tier VPS](YouTube-Videos/20260529_youtube_oracle-cloud-free-tier-vps.md) / [Claude Opus 4.8 동적 워크플로우](YouTube-Videos/20260529_youtube_claude-opus-48-dynamic-workflow.md)|
...
#### Antigravity-K 아키텍처
- [재귀적 자기개선 아키텍처](pages/antigravity-k-recursive-self-improvement.md) — CognitiveLoop, FailureMemory, QualityGate, AutonomousLearner, ReflectionAgent, ImmuneSystem 6개 모듈의 피드백 루프 구조 및 진단·복원 기록
- [에이전트 출력 품질 안정화](pages/antigravity-k-output-stabilization.md) — thinking-tag 유출, CJK 혼입, 반복 루프 방지를 위한 다층 필터 및 모델 튜닝 기법

#### 로컬 LLM 운용
- [Ollama Native API vs OpenAI 호환 API](pages/antigravity-k-ollama-native-api.md) — VRAM 제어(`num_ctx`), reasoning/thinking 토큰 처리, Apple Silicon 메모리 관리

#### 대시보드 & UI
- [대시보드 실시간 연동](pages/antigravity-k-dashboard-realtime.md) — Kanban 이벤트 버스 연동, Think Block 아코디언 UI, 스트리밍 시각 피드백, 빌드 파이프라인
...
- **IEC 60092 선박 전기 표준**
  ...
  - [IEC 60092-301 Generators & Motors](My_Wiki/Topics/IEC_60092-301_Generators_Motors.md)
  - [IEC 60092-350 Cables](My_Wiki/Topics/IEC_60092-350_Cables.md)
  - [IEC 60092-401 Installation](My_Wiki/Topics/IEC_60092-401_Installation.md)
  - [IEC 60092-504 Automation & Control](My_Wiki/Topics/IEC_60092-504_Automation_Control.md)
- **Plantler AI 프로젝트**
  - [Plantler AI 식물 분석 시스템](My_Wiki/Topics/Plantler AI 식물 분석 시스템.md)
  - [Plantler UI/UX 디자인 진화 기록](My_Wiki/Topics/Plantler UIUX 디자인 진화 기록.md)
  - [Plantler 백업복원 시스템 통합기](My_Wiki/Topics/Plantler 백업복원 시스템 통합기.md)
- **Ssak 시리즈**
  - [Ssak 시리즈 공통 설계 패턴](My_Wiki/Topics/Ssak 시리즈 — 4개 프로그램의 공통 설계 패턴.md)
  - [Ssak Image — AI 백엔드 폴백](My_Wiki/Topics/Ssak Image — AI 백엔드 폴백 아키텍처.md)
  - [Ssak Image — 중복 탐지 알고리즘](My_Wiki/Topics/Ssak Image — 이미지 중복 탐지 알고리즘 설계.md)
  - [Ssak Language — AI 다국어 학습](My_Wiki/Topics/Ssak Language — AI 기반 다국어 학습 프로그램.md)
  - [Ssak Language — AI 모델 3단 폴백](My_Wiki/Topics/Ssak Language — AI 모델 3단 폴백 전략.md)
  - [Ssak Language — 게이미피케이션과 수익](My_Wiki/Topics/Ssak Language — 게이미피케이션과 프리미엄 수익 모델.md)
  - [Ssak Language — Lazy Loading 최적화](My_Wiki/Topics/Ssak Language — 프레임 Lazy Loading으로 앱 시작 최적화.md)
  - [Ssak Reader — AI 의미론적 검색](My_Wiki/Topics/Ssak Reader AI 의미론적 검색 아키텍처.md)
  - [Ssak Reader — 경고 억제 시스템](My_Wiki/Topics/Ssak Reader 경고 억제 시스템 — 깨끗한 터미널의 기술.md)
  - [Ssak Reader — DB 동시성 해결](My_Wiki/Topics/Ssak Reader 데이터베이스 동시성 문제와 해결.md)

#### 📁 Projects (프로젝트 기록 — 23건)
- [Plantler UI 및 AI 고도화](My_Wiki/Projects/Plantler UI 및 AI 고도화 작업 내역.md)
- [Plantler 개발 과정 실전 교훈](My_Wiki/Projects/Plantler 개발 과정에서 배운 실전 교훈들.md)
- [Plantler 배포 워크플로우](My_Wiki/Projects/Plantler 배포 워크플로우 — SCP 직접 전송 방식.md)
- [Plantler 인증 시스템 진화](My_Wiki/Projects/Plantler 인증 시스템 진화 기록.md)
- [Plantler 커뮤니티 기능](My_Wiki/Projects/Plantler 커뮤니티 기능 개발 여정.md)
- [Ssak File — 버전 진화 기록](My_Wiki/Projects/Ssak File — 버전 진화 기록 (1.0 → 1.1).md)
- [Ssak Image — 데스크탑 패키징 배포](My_Wiki/Projects/Ssak Image — 데스크탑 패키징과 Microsoft Store 배포.md)
- [Ssak Reader — 출시 및 최적화](My_Wiki/Projects/Ssak Reader (MoficTTS) 출시 및 최적화 내역.md)
- [Ssak Reader — 오프라인 모델 배포](My_Wiki/Projects/Ssak Reader 오프라인 모델 배포 전략.md)
- [Ssak Reader — Windows 호환성](My_Wiki/Projects/Ssak Reader Windows 호환성 이슈 모음.md)
...
> `/Users/mr.k/wiki/My_Wiki/LLM-Wiki/` 하위에 분류된 전문 지식

#### 📁 선급 전기설계 Rule (5건)
- [ABS 미국선급](My_Wiki/LLM-Wiki/선급_전기설계_Rule/01_ABS_미국선급.md)
- [LR 영국선급](My_Wiki/LLM-Wiki/선급_전기설계_Rule/02_LR_영국선급.md)
- [KR 한국선급](My_Wiki/LLM-Wiki/선급_전기설계_Rule/03_KR_한국선급.md)
...
- [금융시장 동향 (2026-05-16)](My_Wiki/Topics/금융시장_동향_2026-05-16.md) — KOSPI 7,493급락, S&P 500 7,408, 나스닥 26,225
- [호르무즈해협 지정학적 리스크와 투자](My_Wiki/LLM-Wiki/거시경제_및_투자_트렌드/01_호르무즈해협_지정학적_리스크와_투자.md)

#### 📁 조선업계 트렌드 (1건)
- [2025-2026 조선업 최신동향](My_Wiki/LLM-Wiki/조선업계_트렌드/01_2025_2026_조선업_최신동향.md)

#### 📁 GithubRepos (15개 프로젝트 분석)
- [awesome-agent-evolution](My_Wiki/LLM-Wiki/GithubRepos/awesome-agent-evolution/_Index.md)
- [claude-code-source-code](My_Wiki/LLM-Wiki/GithubRepos/claude-code-source-code/_Index.md)
- [claude-code-source-code-full](My_Wiki/LLM-Wiki/GithubRepos/claude-code-source-code-full/_Index.md)
- [claude-code-working](My_Wiki/LLM-Wiki/GithubRepos/claude-code-working/_Index.md)
- [claude-multimodel](My_Wiki/LLM-Wiki/GithubRepos/claude-multimodel/_Index.md)
- [claude-notifications-go](My_Wiki/LLM-Wiki/GithubRepos/claude-notifications-go/_Index.md)
- [claude_agent_teams_ui](My_Wiki/LLM-Wiki/GithubRepos/claude_agent_teams_ui/_Index.md)
- [evolver](My_Wiki/LLM-Wiki/GithubRepos/evolver/_Index.md)
- [gbrain](My_Wiki/LLM-Wiki/GithubRepos/gbrain/_Index.md)
- [gstack](My_Wiki/LLM-Wiki/GithubRepos/gstack/_Index.md)
- [hermes-for-web](My_Wiki/LLM-Wiki/GithubRepos/hermes-for-web/_Index.md)
- [nanobanana-pro-obsidian](My_Wiki/LLM-Wiki/GithubRepos/nanobanana-pro-obsidian/_Index.md)
- [obsidian-code](My_Wiki/LLM-Wiki/GithubRepos/obsidian-code/_Index.md)
- [ui-expert-mcp](My_Wiki/LLM-Wiki/GithubRepos/ui-expert-mcp/_Index.md)
...
### 7. 프로젝트 분석 (Project Analysis)

#### Antigravity-K 코드베이스 정밀 분석
- [Antigravity-K 정밀 분석 — 현재상태 (2026-05-11)](/Users/mr.k/wiki/My_Wiki/Projects/Antigravity-K-정밀분석-현재상태-20260511.md)
  - **코드베이스**: 220개 파일, 58,689행
  - **핵심 분포**: engine/ 133개(37,884 LOC) → tools/ 41개(11,088 LOC) → agents/ 14개(2,727 LOC) → api/ 15개(3,691 LOC)
  - **테스트**: 57개 파일, 8,302행 (14.1% 테스트 포함)
  - **핵심 문제**: Guardrail default allow, Git reset 안전성, asyncio nested call, browser tool 중복
  - **완성도 평가**: 6/10 (설계 우수 but 구현 미완성 다수, 핵심 모듈 테스트 부족)
...
#### 📁 AI 코딩 에이전트 & 도구
- [SmallCode — 소형 LLM(7B~20B) 전용 코딩 에이전트](pages/tools/smallcode-local-coding-agent.md) — 컨텍스트 예산 관리, 다중 포맷 도구 파서, TODO 기반 분해, patch 우선 편집. 로컬 완전 구동 가능. MIT License
- [AgentMemory — AI 코딩 에이전트 영구 메모리](pages/tools/agentmemory-permanent-memory.md) — 4-Tier 메모리(Working→Episodic→Semantic→Procedural), BM25+Vector+Graph 트리플 검색, 모든 MCP/REST 에이전트 호환, LongMemEval-S 벤치 95.2%. Apache-2.0
