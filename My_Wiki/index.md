...
| Ssaq Image — 데스크탑 패키징/MS Store 배포.md | Ssaq Image 배포 | Deploy | |
| Ssaq Image — 이미지 중복 탐지 알고리즘 설계.md | Ssaq Image 알고리즘 | Tech | |
| Ssaq Language — AI 기반 다국어 학습.md | Ssaq Language 학습 | Tech | [[Ssaq Language 게이미피케이션]] |
| Ssaq Language — 프레임 Lazy Loading 최적화.md | Ssaq Language 최적화 | Tech | |
| Ssaq Language — 게이미피케이션+프리미엄 수익.md | Ssaq Language 비즈니스 Model | Biz | |
| Ssaq Reader — 데이터베이스 동시성 문제.md | Ssaq Reader DB 문제 | Tech | |
| Ssaq Reader — AI 의미론적 검색 아키텍처.md | Ssaq Reader AI 검색 | Tech | |
| Ssaq Reader — 경계 억제 시스템.md | Ssaq Reader 오류처리 | Tech | |
| Ssaq Reader — AI 기반 문서 관리.md | Ssaq Reader概述 | Tech | [[Ssaq Reader 출시 및 최적화]] |
| Ssaq Reader — 배포 및 최적화 내역.md | Ssaq Reader 배포 | Deploy | [[Ssaq Reader Windows 호환성 이슈]] |
| Ssaq Reader — Windows 호환성 이슈.md | Ssaq Reader Windows | Tech | |
| Ssaq 시리즈 — 공통 설계 패턴.md | Ssaq 시리즈 패턴 | Arch | |
| Ssaq Image — AI 백엔드 폴백 아키텍처.md | Ssaq Image 백엔드 | Tech | |
| M5Max Local LLM 전략.md | M5Max Local LLM | Hardware | |
| Ssaq File — 버전 진화记录.md | Ssaq File 버전 | Version | |
...
### "Ssaq Reader 데이터베이스 문제 해결방안이 뭐였지?"
→ `Topics/Ssaq Reader — 데이터베이스 동시성 문제와 해결.md`
...
| **Projects** | 16개 파일 | 프로젝트 문서 (Plantler, Ssaq, Antigravity-K) |
| **Decisions** | 4개 파일 | 의사결정 기록 |
| **Skills** | 2개 파일 | 워크플로우 스킬 |
| **Templates** | 2개 파일 | NLW 템플릿 |
| **LLM-Wiki** | ~40개 | 도메인별 지식 (GithubRepos, 선급, 전기, etc.) |
| **RAM** | 2개 폴더 | 원본 captured (captures, videos) |
| **🆕 My_Wiki/Memories/** | **새로 추가** | K 프로필, 학습 기록, 프로젝트 메모리 |
...
2. ram/ 폴더에 원본 저장 (Claude.md 규칙 준수)
