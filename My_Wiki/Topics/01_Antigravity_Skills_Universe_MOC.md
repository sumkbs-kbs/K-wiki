...
>
> **⚠️ 중요**: 이 맵의 `[[스킬명]]` 링크들은 **Hermes Agent의 내장 스킬**을 참조합니다. 실제 Wiki 파일이 아닌 개념적 참조이므로, 각 스킬의 상세 매핑은 [antigravity-skills-stub.md](antigravity-skills-stub.md)를 보세요.
...
> 상세 매핑 → [antigravity-skills-stub.md](antigravity-skills-stub.md)
...
- `[[Plantler_Skills_MOC]]` : Plantler 전용 아키텍처, 유지보수, 기획 및 디버깅 스킬 허브 모음 → [03_Plantler_Skills_MOC.md](03_Plantler_Skills_MOC.md)

---

## 📎 스킬 상세 매핑 및 Wiki 교차 참조

모든 38개 스킬의 Wiki ↔ Hermes 매핑 상세:

→ [antigravity-skills-stub.md](antigravity-skills-stub.md) (상세 매핑 테이블)

---

> 각 `[[스킬명]]`은 실제 Wiki 파일이 아닌 **개념적 참조**입니다.
> 실제 스킬은 `.hermes/skills/` 또는 시스템 내장 스킬 시스템에 정의되어 있습니다.
